...
class Chat(models.Model):
    ...
    last_message = models.IntegerField(verbose_name='Id последнего сообщения', null=True)
    class Meta:
        ordering = ['id']
        verbose_name = 'Чат'
...
class Message(models.Model):
    ...
    added_at = models.DateTimeField(verbose_name='Время добавления сообщения', null=False, auto_now_add=True)
    class Meta:
        ordering = ['id']
